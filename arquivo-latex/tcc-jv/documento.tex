...
% Limita profundidade do sumário: 0=chapter, 1=section, 2=subsection
...
\titulo{Comparação e Análise de Cenários na Predição de Qualidade de Vida com Dados de Wearables}
%\titulo{Limitações Metodológicas na Predição de Qualidade de Vida com Dados de Wearables: Um Estudo Comparativo}
\data{2026}
\local{Fortaleza}
...
%	\imprimirglossario	
	...
	%\imprimiranexos
		% Adicione aqui os anexos do seu trabalho se necessário
